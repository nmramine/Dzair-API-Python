...
cur.execute("CREATE TABLE `users` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `public_id` int(11) NOT NULL, `name` varchar(50) DEFAULT NULL, `password` varchar(50) DEFAULT NULL)")
